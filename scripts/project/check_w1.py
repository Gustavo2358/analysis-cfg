...
SOURCES={f'analysis-kernel/src/main/java/io/github/gustavo2358/analysis/structure/{name}.java' for name in ['AnalysisSession','ProgramIndex','IndexBuilder','ContextView','OpenControl','IndexMetrics','LongIntDirectory']}
