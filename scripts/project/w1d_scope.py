...
NEW_W5 = {'analysis-adapters/src/main/java/io/github/gustavo2358/analysis/adapters/'+n+'.java' for n in ('DependencyJson','DependencyFileWriter','FileDependencyJson','SourceDependencyJson')} | {'analysis-launcher/src/main/java/io/github/gustavo2358/analysis/launcher/AnalysisDependencies.java'}
