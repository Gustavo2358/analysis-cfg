...
'restore-negative-separation-gate':(P,[('// Each Cell StorageId is an independent slot; aliases share a CellBinding.','if(cells.size()>1) throw new Refusal(false,"UNPROVEN_STORAGE_DISJOINTNESS");')],'ValuesTest#sameCellAliasesAndIndependentBasesAreSemanticAdmission','independent positive bases must remain admitted'),
