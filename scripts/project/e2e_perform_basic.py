...
def source_oracle(sp, case):
    require(sp['contractVersion'] in ('1.8.0','1.9.0','2.0.0','2.1.0','2.2.0', '2.3.0', '2.4.0', '2.5.0', '2.6.0', '2.7.0') and sp['unit']['canonicalProgramName'] == 'CALLER', 'real CALLER at SP1.8')
