...
TESTS['analysis-adapters']['RegionalWireTest']=set(['fileProductCarriesIndependentCompositionAndCopyIntervals', 'inventoryAndQueryPermutationPreserveTheEntireWire', 'hugeUnknownTailZeroAndLogicalCellsRetainTheirDistinctWireShapes'])
