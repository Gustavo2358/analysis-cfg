...
VALUE_NAMES='Candidates SupportSet PersistentBindings PossibleValuesState ValuesWork ValueUniverse LogicalText TextExpressions TextPredicate TextProfile ForeignEffectTransfer ConservativeEffectTransfer ValueFact PossibleValuesAnalysis ByteImage TextValueFact RegionalValueFact RegionalValuesAnalysis RegionalAlternatives FactorizedAlternatives StorageValueFact StorageValueOrder StorageAnalysisMode'.split()
...
'ValuesTest':set('realVerticalMixedBatchHasOneObservationPerLogicalQuery partialSourceIsSeparateFromExactModelAndUnknownWitness diamondsMissingPathsStrongUpdatesAndOtherCells sameCellAliasesAndIndependentBasesAreSemanticAdmission directReadIsCopyWhileOtherEffectsAndIndirectStorageRemainUnsupported entrySeedsContextsUnreachableAndUnicodeKeepTheirIdentity auxiliaryIntegerCellsPreserveTextCandidatesWithoutPremises'.split()),
