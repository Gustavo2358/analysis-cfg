#!/usr/bin/env python3
"""Compiled W1D module and consumer capabilities, and generic foundation boundaries."""
...
def source_boundaries(root):
    ...
    plan=(root/'analysis-dataflow/src/main/java/io/github/gustavo2358/analysis/dataflow/DefaultValuePlan.java').read_text()
    if any(token in plan for token in ('Operations.Invoke', 'ComputedTarget', 'LiteralTarget', 'CallNameInterpreter')):
