...
def main() -> int:
    ...
    cases = [
        ...
        ("08a-enum-name-wire", ADAPTER + "CfgJsonWriter.java", 'out.string(transitionKind(transition.kind()))',
         'out.string(transition.kind().name())', shape, "runtime enum/object rendering"),
        ("08b-enum-to-string-wire", ADAPTER + "CfgJsonWriter.java", 'out.string(transitionKind(transition.kind()))',
