...
final class FileDependencyJson {
    ...
    static Object value(FileDependencyResult f){
        return object("valuesProfile","file-values-context@1","declarationInventory",inventory(f.declarationInventory()),
