...
final class WireAdversarialTest {
    @Test void unavailableBatchRetainsItsExplicitDependencyReason()throws Exception {
        ...
        // Direct Read and fixed fitting are supported; general trimming stays outside this profile.
        var fit=new io.github.gustavo2358.air.model.Expressions.TrimRight(ResultFixtures.operand(assign.header().id(),"trim",io.github.gustavo2358.air.model.Operand.Role.VALUE_READ),read," ");
