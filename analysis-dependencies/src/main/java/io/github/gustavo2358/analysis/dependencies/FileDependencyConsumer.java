...
final class FileDependencyConsumer implements FactConsumer<Site> {
    ...
    static boolean selected(Operations.Invoke i){return i.target() instanceof Interactions.LiteralTarget t&&t.category().equals("file")||i.target() instanceof Interactions.ComputedTarget c&&c.category().equals("file");}
